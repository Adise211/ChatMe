...
Install ChatMe directly from the release branch:

```bash
npm install github:Adise211/chatme#release
```
...
function App() {
  ...
  const handleNewConversation = () => {
    ...
    // Implement your conversation creation logic
  };
  ...
  return (
    <div className="h-screen">
      <ChatMe
        ...
        onEditConversation={(id, name) => console.log("Edited:", id, name)}
      />
    </div>
  );
}
